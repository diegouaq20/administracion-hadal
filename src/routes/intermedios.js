...
router.get('/edit-contact/:id', async (req, res) => {
    try {
        ...
        res.render('edit-intermedios', { contact: contactData, contactId });
    } catch (error) {
...
// Ruta para actualizar un servicio intermedio// Ruta para actualizar un servicio intermedio
router.post('/update-contact/:id', async (req, res) => {
    try {
        ...
        res.redirect('/servicios-intermedios'); // Redirige de vuelta a la página de servicios intermedios
    } catch (error) {
